...
Scénario : crée un personnage, joue 10 actions dont les cas limites (soin au max, dégâts mortels, sac plein, équiper un objet absent).`,
    ...
    criteria: ['Modèle du personnage complet et cohérent', 'Tous les cas limites du scénario gérés (pv bornés, sac plein, objet absent)', 'bilan() lisible sans effort', 'Destructuring utilisé là où il clarifie'],
