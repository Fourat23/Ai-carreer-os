#!/usr/bin/env node
// Gate V32 — lance : npm run v32:check
//
// Valide STRUCTURELLEMENT les leçons du périmètre V32 (cf.
// docs/architecture/v32-lessons-plan.json) : leçons de la chaîne RAG / IA appliquée durcies
...
// rapport CP11 (docs/PEDAGOGICAL-AUDIT-V32.md).
//
...
const planPath = R('docs/architecture/v32-lessons-plan.json');
if (!existsSync(planPath)) {
  console.log('── Gate V32 (Agents, tool use & sûreté IA) ──');
  console.log('⚠️  plan v32-lessons-plan.json absent : rien à valider (attendu avant CP2).');
  console.log('\n✅ V32 valide (aucun périmètre déclaré).');
  process.exit(0);
}
...
console.log('\n✅ V32 valide : périmètre conforme (on-ramp, prérequis, vocabulaire, liens, pratique, graphe acyclique, réel/simulé).');
