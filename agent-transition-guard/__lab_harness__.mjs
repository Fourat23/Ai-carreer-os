...
const TESTS = [{"id":"t1","kind":"call-equals","export":"canTransition","args":["plan","act",{"plan":["act"],"act":["observe"]}]},{"id":"t2","kind":"call-equals","export":"canTransition","args":["idle","act",{"idle":["plan"],"plan":["act"]}]},{"id":"t3","kind":"call-equals","export":"canTransition","args":["ghost","act",{"plan":["act"]}]}];
(async () => {
