...
const TESTS = [{"id":"t1","kind":"call-equals","export":"choose","args":[{"mutating":true,"retriable":true,"naturallyIdempotent":false}]},{"id":"t2","kind":"call-equals","export":"choose","args":[{"mutating":false,"retriable":true,"naturallyIdempotent":false}]},{"id":"t3","kind":"call-equals","export":"choose","args":[{"mutating":true,"retriable":true,"naturallyIdempotent":true}]}];
(async () => {
