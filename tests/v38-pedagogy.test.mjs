// CP2 (V38) — intégrité du dispositif d'audit pédagogique V38 : plan, ledger,
...
const plan = JSON.parse(readFileSync(R('docs/architecture/v38-lessons-plan.json'), 'utf8'));
const ledger = JSON.parse(readFileSync(R('docs/architecture/v38-pedagogy-audit.json'), 'utf8'));
