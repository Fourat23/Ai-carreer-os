...
const TESTS = [{"id":"t1","kind":"call-equals","export":"failFast","args":[[{"id":"a","status":"success"},{"id":"b","status":"failed"},{"id":"c","status":"pending"},{"id":"d","status":"pending"}]]},{"id":"t2","kind":"call-equals","export":"failFast","args":[[{"id":"a","status":"success"},{"id":"b","status":"pending"}]]},{"id":"t3","kind":"call-equals","export":"failFast","args":[[{"id":"a","status":"pending"},{"id":"b","status":"failed"}]]},{"id":"t4","kind":"call-equals","export":"failFast","args":[[{"id":"a","status":"failed"},{"id":"b","status":"success"},{"id":"c","status":"pending"}]]},{"id":"t5","kind":"call-equals","export":"failFast","args":[[]]}];
(async () => {
