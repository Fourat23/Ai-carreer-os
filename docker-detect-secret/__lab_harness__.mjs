...
const TESTS = [{"id":"t1","kind":"call-equals","export":"findSecretLeaks","args":[["FROM node:20","ENV API_KEY=sk-123","CMD node app"]]},{"id":"t2","kind":"call-equals","export":"findSecretLeaks","args":[["FROM node","COPY .env /app/.env"]]},{"id":"t3","kind":"call-equals","export":"findSecretLeaks","args":[["ARG TOKEN","FROM node"]]},{"id":"t4","kind":"call-equals","export":"findSecretLeaks","args":[["ENV DB_PASSWORD=p","ENV OTHER=1","ARG SECRET_KEY=z"]]},{"id":"t5","kind":"call-equals","export":"findSecretLeaks","args":[["FROM alpine","RUN apk add curl"]]}];
(async () => {
