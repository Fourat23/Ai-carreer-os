...
const TESTS = [{"id":"t1","kind":"call-equals","export":"blastRadius","args":[[{"id":"db","dependsOn":[]},{"id":"api","dependsOn":["db"]},{"id":"w","dependsOn":["db"]}],"db"]},{"id":"t2","kind":"call-equals","export":"blastRadius","args":[[{"id":"x","dependsOn":[]}],"x"]},{"id":"t3","kind":"call-equals","export":"blastRadius","args":[[{"id":"a","dependsOn":[]},{"id":"b","dependsOn":["a"]}],"a"]}];
(async () => {
