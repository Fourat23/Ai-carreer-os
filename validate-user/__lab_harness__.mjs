...
const TESTS = [{"id":"t-ok","kind":"call-equals","export":"validateUser","args":[{"name":"Alice","email":"a@b.co"}]},{"id":"t-name","kind":"call-equals","export":"validateUser","args":[{"name":"A","email":"a@b.co"}]},{"id":"t-email","kind":"call-equals","export":"validateUser","args":[{"name":"Alice","email":"bad"}]},{"id":"t-both","kind":"call-equals","export":"validateUser","args":[{"name":"","email":"bad"}]}];
(async () => {
  let mod = null, importError = null;
  try { mod = await import("./validate.mjs"); }
