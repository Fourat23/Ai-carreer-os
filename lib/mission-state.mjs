...
export function recordMissionCompletion(flat, missionDef, now = new Date().toISOString()) {
  ...
  // V65 · plus aucune écriture directe d'un niveau de compétence (P2). La
  // mission produit une PREUVE qualifiante ; la compétence se projette.
  const ev = makeEvidence({
    ...
    title: `Mission terminée : ${missionDef.title}`,
    provenance: { producer: 'mission-engine', method: 'mission-deliverables', note: 'Auto-vérifiés, structure validée, revue effectuée.' },
