...
const TESTS = [{"id":"t1","kind":"call-equals","export":"orderPipeline","args":[["load","extract","transform","clean"]]},{"id":"t2","kind":"call-equals","export":"orderPipeline","args":[["transform","extract"]]}];
(async () => {
