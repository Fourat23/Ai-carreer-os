...
const TESTS = [{"id":"t1","kind":"call-equals","export":"groupHaving","args":[[{"cat":"a","amount":5},{"cat":"a","amount":5},{"cat":"b","amount":3}],8]},{"id":"t2","kind":"call-equals","export":"groupHaving","args":[[{"cat":"x","amount":10}],5]},{"id":"t3","kind":"call-equals","export":"groupHaving","args":[[{"cat":"a","amount":1}],100]},{"id":"t4","kind":"call-equals","export":"groupHaving","args":[[{"cat":"b","amount":9},{"cat":"a","amount":9}],9]}];
(async () => {
