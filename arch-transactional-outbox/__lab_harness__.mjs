...
const TESTS = [{"id":"t1","kind":"call-equals","export":"choose","args":[{"needsEvent":true,"mustNotLose":true}]},{"id":"t2","kind":"call-equals","export":"choose","args":[{"needsEvent":false,"mustNotLose":true}]},{"id":"t3","kind":"call-equals","export":"choose","args":[{"needsEvent":true,"mustNotLose":false}]}];
(async () => {
