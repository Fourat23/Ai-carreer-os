...
const TESTS = [{"id":"t1","kind":"call-equals","export":"indexAdvice","args":[{"reads":100,"writes":5,"selectiveColumn":true,"rangeQueries":true}]},{"id":"t2","kind":"call-equals","export":"indexAdvice","args":[{"reads":5,"writes":100,"selectiveColumn":true,"rangeQueries":true}]},{"id":"t3","kind":"call-equals","export":"indexAdvice","args":[{"reads":100,"writes":1,"selectiveColumn":false,"rangeQueries":false}]},{"id":"t4","kind":"call-equals","export":"indexAdvice","args":[{"reads":100,"writes":1,"selectiveColumn":true,"rangeQueries":false}]}];
(async () => {
