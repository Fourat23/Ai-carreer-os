...
export async function runExercise(root, exercise, userFiles = {}) {
  ...
  // Runtime de PREVIEW (web) : pas d'exécution serveur. L'évaluation des
  // assertions web est branchée en CP6 (modèle DOM). D'ici là, on ne spawn pas.
  if (adapter.preview || adapter.kind === 'web') {
    throw new Error('Évaluation des exercices web bientôt disponible.');
  }
