...
export const LESSONS = [
  ...
  { file: 'async-messaging-queues.md', title: 'Travail asynchrone : files, workers, retry et idempotence', cat: 'Software engineering & architecture', level: 3, min: 55, skills: ['archi', 'se'], practiceRefs: [{ kind: 'exercise', id: 'queue-idempotent-consumer' }, { kind: 'exercise', id: 'dlq-routing' }, { kind: 'exercise', id: 'retry-backoff-delay' }] },
