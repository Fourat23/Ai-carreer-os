...
const TESTS = [{"id":"t1","kind":"call-equals","export":"signalFor","args":["graceful"]},{"id":"t2","kind":"call-equals","export":"signalFor","args":["force"]},{"id":"t3","kind":"call-equals","export":"signalFor","args":["reload"]}];
(async () => {
