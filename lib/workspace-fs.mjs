...
import { resolveWithinRoot, buildHarness, gradeRun, parseHarnessOutput, HARNESS_FILE } from './workspace.mjs';
...
export async function runExercise(root, exercise, userFiles = {}) {
  ...
  return { attempt, stdout: userStdout.slice(0, runtime.maxOutputBytes), timedOut, error };
}
