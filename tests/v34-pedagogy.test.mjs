// CP2 (V34) — intégrité du dispositif d'audit pédagogique V34 : plan, ledger,
...
const plan = JSON.parse(readFileSync(R('docs/architecture/v34-lessons-plan.json'), 'utf8'));
const ledger = JSON.parse(readFileSync(R('docs/architecture/v34-pedagogy-audit.json'), 'utf8'));
...
test('plan V34 : structure et slugs valides', () => {
...
test('ledger V34 : valide contre la rubrique partagée', () => {
