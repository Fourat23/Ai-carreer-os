...
const TESTS = [{"id":"t1","kind":"call-equals","export":"startupSafe","args":[{"hasHealthcheck":true,"condition":"service_healthy"}]},{"id":"t2","kind":"call-equals","export":"startupSafe","args":[{"hasHealthcheck":false,"condition":"started"}]},{"id":"t3","kind":"call-equals","export":"startupSafe","args":[{"hasHealthcheck":false,"condition":"service_healthy"}]}];
(async () => {
