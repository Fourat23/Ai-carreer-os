...
export const NIVEAU_MAX_PAR_KIND = Object.freeze({
  ...
  // La conformité de FORME d'un document, plus une revue signée par l'apprenant
  // (V77 · CP5). Le maillon faible interdit d'aller au-delà.
  'mission-deliverables': 'OBSERVED',
