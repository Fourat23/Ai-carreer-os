...
const TESTS = [{"id":"t1","kind":"call-equals","export":"publish","args":[[{"name":"log","types":["error"]},{"name":"audit","types":["error","login"]}],[{"type":"error"},{"type":"login"},{"type":"error"}]]},{"id":"t2","kind":"call-equals","export":"publish","args":[[{"name":"x","types":["z"]}],[{"type":"a"}]]},{"id":"t3","kind":"call-equals","export":"publish","args":[[{"name":"b","types":["t"]},{"name":"a","types":["t"]}],[{"type":"t"}]]}];
(async () => {
