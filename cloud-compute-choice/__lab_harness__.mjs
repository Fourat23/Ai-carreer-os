...
const TESTS = [{"id":"t1","kind":"call-equals","export":"computeChoice","args":[{"needsOsControl":true}]},{"id":"t2","kind":"call-equals","export":"computeChoice","args":[{"needsOsControl":false,"spiky":true}]},{"id":"t3","kind":"call-equals","export":"computeChoice","args":[{"needsOsControl":false,"spiky":false}]}];
(async () => {
