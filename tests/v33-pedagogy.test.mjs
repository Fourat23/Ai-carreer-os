// CP2 (V33) — intégrité du dispositif d'audit pédagogique V33 : plan, ledger,
...
const plan = JSON.parse(readFileSync(R('docs/architecture/v33-lessons-plan.json'), 'utf8'));
const ledger = JSON.parse(readFileSync(R('docs/architecture/v33-pedagogy-audit.json'), 'utf8'));
...
test('plan V33 : structure et slugs valides', () => {
...
test('ledger V33 : valide contre la rubrique partagée', () => {
