...
export const LESSONS = [
  ...
  { file: 'frontend-testing.md', title: 'Tester une interface : comportement, pas implémentation', cat: 'Frontend & React', level: 3, min: 50, skills: ['jsts', 'se'], practiceRefs: [{ kind: 'exercise', id: 'react-debug-list' }, { kind: 'exercise', id: 'react-search' }] },
