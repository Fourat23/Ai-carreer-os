// CP2 (V30) — intégrité du dispositif d'audit pédagogique V30 : plan, ledger,
...
const ledger = JSON.parse(readFileSync(R('docs/architecture/v30-pedagogy-audit.json'), 'utf8'));
...
test('plan V30 : structure et slugs valides', () => {
...
test('ledger V30 : valide contre la rubrique partagée', () => {
