...
const ENTRY = "./App.js";
const TESTS = [{"id":"t1","name":"un item par entrée","kind":"element-count","selector":".menu-item","attribute":null,"role":null,"expected":3,"props":{"items":["Fichier","Édition","Vue"]}},{"id":"t2","name":"contenu ordonné","kind":"list-content","selector":".menu-item","attribute":null,"role":null,"expected":["A","B"],"props":{"items":["A","B"]}},{"id":"t3","name":"la cible du callback est un bouton","kind":"accessible-role-exists","selector":null,"attribute":null,"role":"button","expected":null,"props":{"items":["X"]}},{"id":"t4","name":"liste vide (privé)","kind":"element-count","selector":".menu-item","attribute":null,"role":null,"expected":0,"props":{"items":[]}}];
