...
const TESTS = [{"id":"t1","kind":"call-equals","export":"nextState","args":[2,5]},{"id":"t2","kind":"call-equals","export":"nextState","args":[5,5]},{"id":"t3","kind":"call-equals","export":"nextState","args":[7,5]}];
(async () => {
