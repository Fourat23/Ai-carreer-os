// CP2 (V37) — intégrité du dispositif d'audit pédagogique V37 : plan, ledger,
...
const plan = JSON.parse(readFileSync(R('docs/architecture/v37-lessons-plan.json'), 'utf8'));
const ledger = JSON.parse(readFileSync(R('docs/architecture/v37-pedagogy-audit.json'), 'utf8'));
