...
const TESTS = [{"id":"t1","kind":"call-equals","export":"spofKinds","args":[[{"kind":"api"},{"kind":"relational-db"},{"kind":"relational-db"}]]},{"id":"t2","kind":"call-equals","export":"spofKinds","args":[[{"kind":"api"},{"kind":"api"},{"kind":"load-balancer"},{"kind":"load-balancer"}]]},{"id":"t3","kind":"call-equals","export":"spofKinds","args":[[{"kind":"relational-db"},{"kind":"api"}]]},{"id":"t4","kind":"call-equals","export":"spofKinds","args":[[{"kind":"cache"},{"kind":"monitoring"}]]},{"id":"t5","kind":"call-equals","export":"spofKinds","args":[[]]}];
(async () => {
