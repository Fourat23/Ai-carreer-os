...
const TESTS = [{"id":"t1","kind":"call-equals","export":"hasWildcard","args":[{"verbs":["*"],"resources":["pods"]}]},{"id":"t2","kind":"call-equals","export":"hasWildcard","args":[{"verbs":["get"],"resources":["*"]}]},{"id":"t3","kind":"call-equals","export":"hasWildcard","args":[{"verbs":["get","list"],"resources":["configmaps"]}]},{"id":"t4","kind":"call-equals","export":"hasWildcard","args":[{"verbs":[],"resources":[]}]}];
(async () => {
