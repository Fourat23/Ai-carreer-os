...
const ENTRY = "./App.js";
const TESTS = [{"id":"t1","name":"affiche l’état initial remonté","kind":"text-contains","selector":"#display","attribute":null,"role":null,"expected":"Choix : B","props":{"initial":"B","options":["A","B","C"]}},{"id":"t2","name":"un bouton par option","kind":"element-count","selector":".opt","attribute":null,"role":null,"expected":3,"props":{"initial":"B","options":["A","B","C"]}},{"id":"t3","name":"autre état initial (privé)","kind":"text-contains","selector":"#display","attribute":null,"role":null,"expected":"Choix : X","props":{"initial":"X","options":["X"]}}];
