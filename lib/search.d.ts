...
export interface SearchItem {
  id: string;
  type: 'command' | 'page' | 'day' | 'week' | 'month' | 'skill' | 'project' | 'lesson' | 'track' | 'module' | 'technology' | 'exercise' | 'mission' | 'pipeline' | 'topology' | 'manifest' | 'scenario' | 'playbook' | 'glossary';
  title: string;
  subtitle: string;
  href: string;
  keywords: string;
