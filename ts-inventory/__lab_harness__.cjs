...
const TESTS = [{"id":"t1","kind":"call-equals","export":"totalValue","args":[]},{"id":"t2","kind":"call-equals","export":"totalValue","args":[[{"name":"x","price":5,"qty":3}]]},{"id":"t3","kind":"call-equals","export":"totalValue","args":[[]]}];
(async () => {
