 ...
 */
export function buildIndex(program, catalogue = null, exercises = null, missions = null, pipelines = null, topologies = null) {
  const items = [];
...
const TYPE_ORDER = { command: 0, day: 1, exercise: 2, mission: 2, pipeline: 2, topology: 2, track: 3, module: 4, week: 5, month: 6, skill: 7, technology: 8, project: 9, lesson: 10, page: 11 };
