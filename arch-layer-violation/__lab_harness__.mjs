...
const TESTS = [{"id":"t1","kind":"call-equals","export":"check","args":[{"from":"presentation","to":"domain"}]},{"id":"t2","kind":"call-equals","export":"check","args":[{"from":"data","to":"presentation"}]},{"id":"t3","kind":"call-equals","export":"check","args":[{"from":"domain","to":"data"}]},{"id":"t4","kind":"call-equals","export":"check","args":[{"from":"domain","to":"presentation"}]}];
(async () => {
