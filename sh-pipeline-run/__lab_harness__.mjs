...
const TESTS = [{"id":"t1","kind":"call-equals","export":"runPipeline","args":[["foo","bar","foobar"],[{"op":"grep","arg":"foo"},{"op":"head","arg":1}]]},{"id":"t2","kind":"call-equals","export":"runPipeline","args":[["b","a","a","b"],[{"op":"sort"},{"op":"uniq"}]]},{"id":"t3","kind":"call-equals","export":"runPipeline","args":[["keep","drop me"],[{"op":"reject","arg":"drop"}]]},{"id":"t4","kind":"call-equals","export":"runPipeline","args":[["x","y","z"],[{"op":"count"}]]},{"id":"t5","kind":"call-equals","export":"runPipeline","args":[["a","b"],[{"op":"wat"}]]}];
(async () => {
