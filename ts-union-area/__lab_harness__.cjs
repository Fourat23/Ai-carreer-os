...
const TESTS = [{"id":"t1","kind":"call-equals","export":"area","args":[{"kind":"rect","width":2,"height":3}]},{"id":"t2","kind":"call-equals","export":"area","args":[{"kind":"rect","width":5,"height":5}]},{"id":"t3","kind":"call-equals","export":"area","args":[{"kind":"circle","radius":1}]}];
(async () => {
