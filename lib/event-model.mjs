...
// `assessment` s'ajoute en V77 · CP4 : une soumission de diagnostic ne se
// rattache ni à une journée ni à un exercice — elle se rattache au diagnostic,
// et un grain emprunté serait exactement la « journée d'emprunt » que V65 a
// retirée des preuves.
export const GRAINS = ['day', 'concept', 'competency', 'exercise', 'project', 'week', 'challenge', 'assessment'];
