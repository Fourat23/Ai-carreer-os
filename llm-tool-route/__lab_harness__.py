...
TESTS = json.loads("[{\"id\":\"t1\",\"kind\":\"call-equals\",\"export\":\"route\",\"args\":[\"Quel temps fait-il et la température demain ?\",{\"weather\":[\"temps\",\"température\"],\"calc\":[\"addition\",\"somme\"]}]},{\"id\":\"t2\",\"kind\":\"call-equals\",\"export\":\"route\",\"args\":[\"Raconte une blague\",{\"weather\":[\"temps\"],\"calc\":[\"somme\"]}]},{\"id\":\"t3\",\"kind\":\"call-equals\",\"export\":\"route\",\"args\":[\"somme et temps\",{\"weather\":[\"temps\"],\"calc\":[\"somme\"]}]}]")
ENTRY = "solution.py"
