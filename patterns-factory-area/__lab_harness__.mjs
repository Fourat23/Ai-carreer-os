...
const TESTS = [{"id":"t1","kind":"call-equals","export":"area","args":[{"kind":"square","size":4}]},{"id":"t2","kind":"call-equals","export":"area","args":[{"kind":"circle","size":2}]},{"id":"t3","kind":"call-equals","export":"area","args":[{"kind":"square","size":5}]}];
(async () => {
