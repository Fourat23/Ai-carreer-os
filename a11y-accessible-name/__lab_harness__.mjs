...
const TESTS = [{"id":"t1","kind":"call-equals","export":"accessibleName","args":[{"tag":"button","ariaLabel":"Fermer la fenêtre","text":"✕"}]},{"id":"t2","kind":"call-equals","export":"accessibleName","args":[{"tag":"img","alt":"Graphique des ventes"}]},{"id":"t3","kind":"call-equals","export":"accessibleName","args":[{"tag":"button","text":"Envoyer"}]},{"id":"t4","kind":"call-equals","export":"accessibleName","args":[{"tag":"button","text":""}]},{"id":"t5","kind":"call-equals","export":"accessibleName","args":[{"tag":"img","alt":"","text":"ignoré"}]}];
(async () => {
