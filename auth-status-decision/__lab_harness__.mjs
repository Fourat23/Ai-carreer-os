...
const TESTS = [{"id":"t1","kind":"call-equals","export":"authStatus","args":[{"authenticated":false,"exists":true,"authorized":true}]},{"id":"t2","kind":"call-equals","export":"authStatus","args":[{"authenticated":true,"exists":false,"authorized":true}]},{"id":"t3","kind":"call-equals","export":"authStatus","args":[{"authenticated":true,"exists":true,"authorized":false}]},{"id":"t4","kind":"call-equals","export":"authStatus","args":[{"authenticated":true,"exists":true,"authorized":true}]}];
(async () => {
