...
const JS_PATHS = ["data.js","app.js"];
const TESTS = [{"id":"t1","name":"« p » → 3","kind":"event-changes-text","selector":"#hits","attribute":null,"property":null,"expected":"3","action":{"type":"input","selector":"#q","value":"p"}},{"id":"t2","name":"« kiwi » → 1","kind":"event-changes-text","selector":"#hits","attribute":null,"property":null,"expected":"1","action":{"type":"input","selector":"#q","value":"kiwi"}},{"id":"t3","name":"« z » → 0 (privé)","kind":"event-changes-text","selector":"#hits","attribute":null,"property":null,"expected":"0","action":{"type":"input","selector":"#q","value":"z"}}];
