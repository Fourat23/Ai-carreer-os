...
const TESTS = [{"id":"t1","kind":"call-equals","export":"prodReady","args":[[{"severity":"blocking"},{"severity":"warning"}]]},{"id":"t2","kind":"call-equals","export":"prodReady","args":[[{"severity":"warning"},{"severity":"observation"}]]},{"id":"t3","kind":"call-equals","export":"prodReady","args":[[{"severity":"risk"}]]}];
(async () => {
