...
const TESTS = [{"id":"t1","kind":"call-equals","export":"innerJoin","args":[[{"id":1,"a":"x"},{"id":2,"a":"y"}],[{"id":1,"b":"p"}],"id"]},{"id":"t2","kind":"call-equals","export":"innerJoin","args":[[{"id":1,"a":"x"}],[{"id":9,"b":"z"}],"id"]},{"id":"t3","kind":"call-equals","export":"innerJoin","args":[[{"id":1,"a":"x"},{"id":1,"a":"y"}],[{"id":1,"b":"p"}],"id"]}];
(async () => {
