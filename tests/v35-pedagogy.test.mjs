// CP2 (V35) — intégrité du dispositif d'audit pédagogique V35 : plan, ledger,
...
const plan = JSON.parse(readFileSync(R('docs/architecture/v35-lessons-plan.json'), 'utf8'));
const ledger = JSON.parse(readFileSync(R('docs/architecture/v35-pedagogy-audit.json'), 'utf8'));
