 ...
 * Le catalogue (facultatif) ajoute parcours, modules et technologies. AUCUNE
 * donnée privée (réponses, notes) n'est jamais indexée : l'index ne contient que
 * du contenu de programme/catalogue public.
 ...
 */
export function buildIndex(program, catalogue = null) {
  const items = [];
...
const TYPE_ORDER = { command: 0, day: 1, track: 2, module: 3, week: 4, month: 5, skill: 6, technology: 7, project: 8, lesson: 9, page: 10 };
