...
const TESTS = [{"id":"t1","kind":"call-equals","export":"canPromote","args":[{"ciGreen":true,"artifactPresent":true,"requiresApproval":true,"approved":true}]},{"id":"t2","kind":"call-equals","export":"canPromote","args":[{"ciGreen":true,"artifactPresent":true,"requiresApproval":true,"approved":false}]},{"id":"t3","kind":"call-equals","export":"canPromote","args":[{"ciGreen":false,"artifactPresent":true,"requiresApproval":false}]},{"id":"t4","kind":"call-equals","export":"canPromote","args":[{"ciGreen":true,"artifactPresent":true,"requiresApproval":false}]},{"id":"t5","kind":"call-equals","export":"canPromote","args":[{"ciGreen":true,"artifactPresent":false,"requiresApproval":false}]}];
(async () => {
