...
const ENTRY = "./App.js";
const TESTS = [{"id":"t1","name":"« a » → 2 résultats","kind":"element-count","selector":".hit","attribute":null,"role":null,"expected":2,"props":{"items":["Ananas","Poire","Banane"],"query":"a"}},{"id":"t2","name":"contenu filtré","kind":"list-content","selector":".hit","attribute":null,"role":null,"expected":["Ananas","Banane"],"props":{"items":["Ananas","Poire","Banane"],"query":"an"}},{"id":"t3","name":"aucun résultat (privé)","kind":"element-count","selector":".hit","attribute":null,"role":null,"expected":0,"props":{"items":["x"],"query":"zzz"}}];
