...
export const LESSONS = [
  ...
  { file: 'css-grid.md', title: 'CSS Grid : organiser en lignes et colonnes', cat: 'Frontend : Web Platform', level: 2, min: 50, skills: ['jsts', 'archi'], practiceRefs: [{ kind: 'exercise', id: 'web-card' }, { kind: 'exercise', id: 'web-nav' }] },
  ...
  { file: 'nextjs-rendering.md', title: 'Rendu web : CSR, SSR, SSG et streaming', cat: 'Frontend & React', level: 3, min: 50, skills: ['jsts', 'archi'], practiceRefs: [] },
