...
const TESTS = [{"id":"t1","kind":"call-equals","export":"drift","args":[{"replicas":3,"image":"v2"},{"replicas":3,"image":"v1"}]},{"id":"t2","kind":"call-equals","export":"drift","args":[{"a":1},{"a":1}]},{"id":"t3","kind":"call-equals","export":"drift","args":[{"z":1,"a":2},{"z":9,"a":9}]},{"id":"t4","kind":"call-equals","export":"drift","args":[{"x":"same"},{"x":"same"}]}];
(async () => {
