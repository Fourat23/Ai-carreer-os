...
const TESTS = [{"id":"t1","kind":"call-equals","export":"blastRadius","args":[[{"id":"db","dependsOn":[]},{"id":"api","dependsOn":["db"]},{"id":"worker","dependsOn":["db"]}],"db"]},{"id":"t2","kind":"call-equals","export":"blastRadius","args":[[{"id":"db","dependsOn":[]},{"id":"api","dependsOn":[]}],"db"]},{"id":"t3","kind":"call-equals","export":"blastRadius","args":[[{"id":"lb","dependsOn":[]},{"id":"api","dependsOn":["lb"]}],"lb"]},{"id":"t4","kind":"call-equals","export":"blastRadius","args":[[{"id":"x","dependsOn":[]}],"x"]}];
(async () => {
