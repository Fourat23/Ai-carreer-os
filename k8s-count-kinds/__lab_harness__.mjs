...
const TESTS = [{"id":"t1","kind":"call-equals","export":"countKinds","args":[[{"kind":"Deployment"},{"kind":"Deployment"},{"kind":"Service"}]]},{"id":"t2","kind":"call-equals","export":"countKinds","args":[[{"kind":"Pod"}]]},{"id":"t3","kind":"call-equals","export":"countKinds","args":[[]]},{"id":"t4","kind":"call-equals","export":"countKinds","args":[[{"kind":"ConfigMap"},{"kind":"Secret"},{"kind":"Ingress"}]]},{"id":"t5","kind":"call-equals","export":"countKinds","args":[[{"kind":"Job"},{"kind":"Job"},{"kind":"Job"}]]}];
(async () => {
