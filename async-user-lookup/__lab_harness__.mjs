...
const TESTS = [{"id":"t1","kind":"call-equals","export":"fetchUserName","args":[1]},{"id":"t2","kind":"call-equals","export":"fetchUserName","args":[3]},{"id":"t3","kind":"call-equals","export":"fetchUserName","args":[99]}];
(async () => {
  let mod = null, importError = null;
  try { mod = await import("./index.mjs"); }
