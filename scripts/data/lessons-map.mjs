...
export const LESSONS = [
  ...
  { file: 'slo-error-budget.md', title: 'SLI, SLO et error budget : la fiabilité comme un budget', cat: 'Observabilité, SRE & fiabilité', level: 2, min: 45, skills: ['archi', 'cloud'], practiceRefs: [{ kind: 'exercise', id: 'cloud-error-budget' }] },
  { file: 'incident-response.md', title: 'Répondre à un incident : méthode sous pression', cat: 'Observabilité, SRE & fiabilité', level: 3, min: 50, skills: ['archi', 'cloud'], practiceRefs: [{ kind: 'exercise', id: 'incident-health-rollup' }, { kind: 'exercise', id: 'cloud-rollback-decision' }, { kind: 'exercise', id: 'k8s-recovery-decision' }, { kind: 'mission', id: 'health-incident-postmortem' }] },
  { file: 'postmortem-rca.md', title: 'Post-mortem et analyse de cause racine (RCA)', cat: 'Observabilité, SRE & fiabilité', level: 3, min: 45, skills: ['archi', 'comm'], practiceRefs: [{ kind: 'exercise', id: 'sec-recovery-decision' }, { kind: 'mission', id: 'health-incident-postmortem' }] },
  { file: 'resilience-patterns.md', title: 'Patterns de résilience : survivre aux pannes des autres', cat: 'Observabilité, SRE & fiabilité', level: 3, min: 50, skills: ['archi', 'cloud'], practiceRefs: [{ kind: 'exercise', id: 'cloud-detect-spof' }, { kind: 'exercise', id: 'cloud-multi-az' }, { kind: 'exercise', id: 'cloud-rpo-met' }, { kind: 'mission', id: 'cloud-high-availability' }] },
  // ── Systèmes & Linux ──
