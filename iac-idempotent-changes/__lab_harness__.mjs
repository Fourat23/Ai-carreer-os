...
const TESTS = [{"id":"t1","kind":"call-equals","export":"plannedChanges","args":[{"size":"small","count":2},{"size":"small","count":2}]},{"id":"t2","kind":"call-equals","export":"plannedChanges","args":[{"size":"large","count":2},{"size":"small","count":2}]},{"id":"t3","kind":"call-equals","export":"plannedChanges","args":[{"size":"small","count":2,"tag":"prod"},{"size":"small","count":2}]}];
(async () => {
