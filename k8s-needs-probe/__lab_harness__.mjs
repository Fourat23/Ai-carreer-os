...
const TESTS = [{"id":"t1","kind":"call-equals","export":"needsReadiness","args":[{"kind":"service","hasReadiness":false}]},{"id":"t2","kind":"call-equals","export":"needsReadiness","args":[{"kind":"service","hasReadiness":true}]},{"id":"t3","kind":"call-equals","export":"needsReadiness","args":[{"kind":"job","hasReadiness":false}]}];
(async () => {
