...
export const NODE_KINDS = ['lesson', 'exercise', 'mission', 'playbook', 'lab', 'skill', 'assessment'];
 ...
 * }}
 */
export function buildCurriculumGraph({ lessons = [], prereqPlans = [], known = {}, assessments = [] } = {}) {
  ...
  return { lessons: lessonSet, requires, practices, buildsSkill, skills, assessments: assessmentsNorm, nodes, edges, levels, knownExercises: knownEx, reachableExercises: reachableEx, knownSkills };
}
