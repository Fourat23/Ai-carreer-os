...
TESTS = json.loads("[{\"id\":\"t1\",\"kind\":\"call-equals\",\"export\":\"inner_join\",\"args\":[[{\"id\":1,\"nom\":\"A\"},{\"id\":2,\"nom\":\"B\"}],[{\"id\":2,\"nom\":\"X\"}]]},{\"id\":\"t2\",\"kind\":\"call-equals\",\"export\":\"inner_join\",\"args\":[[{\"id\":1,\"nom\":\"A\"}],[{\"id\":9,\"nom\":\"Z\"}]]},{\"id\":\"t3\",\"kind\":\"call-equals\",\"export\":\"inner_join\",\"args\":[[{\"id\":3,\"nom\":\"C\"},{\"id\":1,\"nom\":\"A\"}],[{\"id\":1,\"nom\":\"a\"},{\"id\":3,\"nom\":\"c\"}]]}]")
ENTRY = "solution.py"
