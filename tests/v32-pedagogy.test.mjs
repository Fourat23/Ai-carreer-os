// CP2 (V32) — intégrité du dispositif d'audit pédagogique V32 : plan, ledger,
...
const plan = JSON.parse(readFileSync(R('docs/architecture/v32-lessons-plan.json'), 'utf8'));
const ledger = JSON.parse(readFileSync(R('docs/architecture/v32-pedagogy-audit.json'), 'utf8'));
...
test('plan V32 : structure et slugs valides', () => {
...
test('ledger V32 : valide contre la rubrique partagée', () => {
