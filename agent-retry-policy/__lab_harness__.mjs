...
const TESTS = [{"id":"t1","kind":"call-equals","export":"decide","args":[{"type":"permission-denied"}]},{"id":"t2","kind":"call-equals","export":"decide","args":[{"type":"rate-limit"}]},{"id":"t3","kind":"call-equals","export":"decide","args":[{"type":"invalid-args"}]},{"id":"t4","kind":"call-equals","export":"decide","args":[{"type":"low-confidence"}]}];
(async () => {
