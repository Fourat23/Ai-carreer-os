...
const TESTS = [{"id":"t1","kind":"call-equals","export":"userName","args":[1]},{"id":"t2","kind":"call-equals","export":"userName","args":[2]},{"id":"t3","kind":"call-equals","export":"userName","args":[99]}];
(async () => {
