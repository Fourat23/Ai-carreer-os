...
const TESTS = [{"id":"t1","kind":"call-equals","export":"rankByCosine","args":[[1,0],[{"id":"A","vec":[10,10]},{"id":"B","vec":[2,0]}],2]},{"id":"t2","kind":"call-equals","export":"rankByCosine","args":[[0,1],[{"id":"X","vec":[0,5]},{"id":"Y","vec":[3,1]},{"id":"Z","vec":[1,0]}],2]},{"id":"t3","kind":"call-equals","export":"rankByCosine","args":[[1,0],[{"id":"A","vec":[10,10]},{"id":"B","vec":[2,0]}],1]}];
(async () => {
