...
const TESTS = [{"id":"t1","name":"saisie « Ada »","kind":"event-changes-text","selector":"#out","attribute":null,"property":null,"expected":"Bonjour, Ada !","action":{"type":"input","selector":"#name","value":"Ada"}},{"id":"t2","name":"saisie « Sam » (privé)","kind":"event-changes-text","selector":"#out","attribute":null,"property":null,"expected":"Bonjour, Sam !","action":{"type":"input","selector":"#name","value":"Sam"}}];
