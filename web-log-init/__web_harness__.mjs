...
const TESTS = [{"id":"t1","name":"console contient le message","kind":"console-contains","selector":null,"attribute":null,"property":null,"expected":"Application prête","action":null}];
