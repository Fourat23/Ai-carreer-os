...
const TESTS = [{"id":"t1","kind":"call-equals","export":"portAllowed","args":[{"from":80,"to":443},443]},{"id":"t2","kind":"call-equals","export":"portAllowed","args":[{"from":80,"to":443},8080]},{"id":"t3","kind":"call-equals","export":"portAllowed","args":[{"from":22,"to":22},22]}];
(async () => {
