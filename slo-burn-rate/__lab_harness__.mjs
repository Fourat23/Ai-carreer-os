...
const TESTS = [{"id":"t1","kind":"call-equals","export":"burnRate","args":[0.5,0.5]},{"id":"t2","kind":"call-equals","export":"burnRate","args":[0.5,0.25]},{"id":"t3","kind":"call-equals","export":"burnRate","args":[0.1,0.2]}];
(async () => {
