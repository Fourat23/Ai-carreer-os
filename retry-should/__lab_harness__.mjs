...
const TESTS = [{"id":"t1","kind":"call-equals","export":"shouldRetry","args":[{"idempotent":true,"attempt":1,"max":3}]},{"id":"t2","kind":"call-equals","export":"shouldRetry","args":[{"idempotent":false,"attempt":1,"max":3}]},{"id":"t3","kind":"call-equals","export":"shouldRetry","args":[{"idempotent":true,"attempt":3,"max":3}]}];
(async () => {
