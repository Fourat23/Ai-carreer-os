...
const TESTS = [{"id":"t1","kind":"call-equals","export":"isOpen","args":[{"defaultDeny":false,"allowFrom":[]}]},{"id":"t2","kind":"call-equals","export":"isOpen","args":[{"defaultDeny":true,"allowFrom":["*"]}]},{"id":"t3","kind":"call-equals","export":"isOpen","args":[{"defaultDeny":true,"allowFrom":["frontend"]}]}];
(async () => {
