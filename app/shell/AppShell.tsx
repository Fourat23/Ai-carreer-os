...
import {
  ...
  Brain, Network, Menu, X, PanelLeftClose, PanelLeftOpen, Terminal, Search, Database, History, Route, FlaskConical, LayoutGrid, Workflow, Boxes, ShieldAlert,
} from 'lucide-react';
...
const ICONS: Record<string, React.ComponentType<{ size?: number; strokeWidth?: number }>> = {
  LayoutDashboard, CalendarDays, BookOpen, Target, FolderGit2, ClipboardCheck,
  NotebookPen, Library, BookMarked, Briefcase, LifeBuoy, GraduationCap, Bot, Bug, Brain, Network, Database, History, Route, FlaskConical, LayoutGrid, Workflow, Boxes, ShieldAlert,
};
