...
const TESTS = [{"id":"t1","name":"le bouton existe","kind":"selector-exists","selector":"#inc","attribute":null,"property":null,"expected":null,"action":null},{"id":"t2","name":"valeur initiale 0","kind":"text-contains","selector":"#count","attribute":null,"property":null,"expected":"0","action":null},{"id":"t3","name":"un clic → 1","kind":"event-changes-text","selector":"#count","attribute":null,"property":null,"expected":"1","action":{"type":"click","selector":"#inc"}},{"id":"t4","name":"deux clics → 2 (privé)","kind":"event-changes-text","selector":"#count","attribute":null,"property":null,"expected":"2","action":{"type":"click","selector":"#inc","times":2}}];
