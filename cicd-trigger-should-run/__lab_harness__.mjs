...
const TESTS = [{"id":"t1","kind":"call-equals","export":"shouldRun","args":[{"trigger":["pull_request"],"branchFilters":["main"]},{"kind":"pull_request","branch":"main"}]},{"id":"t2","kind":"call-equals","export":"shouldRun","args":[{"trigger":["pull_request"],"branchFilters":["main"]},{"kind":"pull_request","branch":"dev"}]},{"id":"t3","kind":"call-equals","export":"shouldRun","args":[{"trigger":["push"]},{"kind":"manual"}]},{"id":"t4","kind":"call-equals","export":"shouldRun","args":[{"trigger":["tag"],"tagFilters":["v1"]},{"kind":"tag","tag":"v2"}]},{"id":"t5","kind":"call-equals","export":"shouldRun","args":[{"trigger":["push"]},{"kind":"push","branch":"x"}]}];
(async () => {
