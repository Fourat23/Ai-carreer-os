...
export const LESSONS = [
  ...
  { file: 'async-messaging-queues.md', title: 'Travail asynchrone : files, workers, retry et idempotence', cat: 'Software engineering & architecture', level: 3, min: 55, skills: ['archi', 'se'], practiceRefs: [{ kind: 'exercise', id: 'queue-idempotent-consumer' }, { kind: 'exercise', id: 'dlq-routing' }] },
  ...
  { file: 'distributed-systems-failures.md', title: 'Systèmes distribués : ce qui casse quand on distribue', cat: 'Software engineering & architecture', level: 3, min: 55, skills: ['archi'], practiceRefs: [{ kind: 'exercise', id: 'cloud-detect-spof' }, { kind: 'exercise', id: 'cloud-replica-count' }, { kind: 'exercise', id: 'queue-idempotent-consumer' }] },
