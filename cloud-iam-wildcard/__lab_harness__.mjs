...
const TESTS = [{"id":"t1","kind":"call-equals","export":"hasWildcard","args":[{"actions":["*"],"resources":["arn:x"]}]},{"id":"t2","kind":"call-equals","export":"hasWildcard","args":[{"actions":["s3:Get"],"resources":["*"]}]},{"id":"t3","kind":"call-equals","export":"hasWildcard","args":[{"actions":["s3:Get"],"resources":["arn:x"]}]}];
(async () => {
