...
const TESTS = [{"id":"t1","kind":"call-equals","export":"missingDeps","args":[[{"id":"build","needs":["lint","ghost"]},{"id":"lint"}]]},{"id":"t2","kind":"call-equals","export":"missingDeps","args":[[{"id":"a"},{"id":"b","needs":["a"]}]]},{"id":"t3","kind":"call-equals","export":"missingDeps","args":[[{"id":"a","needs":["x"]},{"id":"b","needs":["x"]}]]},{"id":"t4","kind":"call-equals","export":"missingDeps","args":[[{"id":"a","needs":["p","q"]}]]},{"id":"t5","kind":"call-equals","export":"missingDeps","args":[[{"id":"a"}]]}];
(async () => {
