...
import { planDeSuppression, violationsDuPlan, verdictDeSuppression } from './learner-data.mjs';
...
export function supprimerToutesLesDonnees(racines, racineProjet) {
  ...
  // Le verdict est DÉRIVÉ des lignes, jamais écrit à la main : voir
  // `verdictDeSuppression` dans `learner-data.mjs`.
  return { ok: verdictDeSuppression(supprime), violations: [], supprime };
}
