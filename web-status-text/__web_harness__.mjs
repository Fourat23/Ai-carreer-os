...
const TESTS = [{"id":"t1","name":"état initial éteint","kind":"text-contains","selector":"#state","attribute":null,"property":null,"expected":"éteint","action":null},{"id":"t2","name":"clic → allumé","kind":"event-changes-text","selector":"#state","attribute":null,"property":null,"expected":"allumé","action":{"type":"click","selector":"#switch"}},{"id":"t3","name":"reste allumé après 2 clics (privé)","kind":"event-changes-text","selector":"#state","attribute":null,"property":null,"expected":"allumé","action":{"type":"click","selector":"#switch","times":2}}];
