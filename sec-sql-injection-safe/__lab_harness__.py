...
TESTS = json.loads("[{\"id\":\"t1\",\"kind\":\"call-equals\",\"export\":\"assess\",\"args\":[{\"sql\":\"SELECT * FROM u WHERE id=?\",\"concatenates_user_input\":false}]},{\"id\":\"t2\",\"kind\":\"call-equals\",\"export\":\"assess\",\"args\":[{\"sql\":\"SELECT * FROM u WHERE id='\",\"concatenates_user_input\":true}]},{\"id\":\"t3\",\"kind\":\"call-equals\",\"export\":\"assess\",\"args\":[{\"sql\":\"SELECT 1\",\"concatenates_user_input\":false}]}]")
ENTRY = "solution.py"
