...
export const LESSONS = [
  ...
  { file: 'networking-http-tls.md', title: 'Réseau : HTTP et TLS', cat: 'Réseau', level: 2, min: 50, skills: ['http', 'secu'], practiceRefs: [{ kind: 'exercise', id: 'net-http-status-class' }, { kind: 'exercise', id: 'http-status' }, { kind: 'exercise', id: 'tls-cert-usable' }, { kind: 'exercise', id: 'http-method-idempotent' }] },
  ...
  { file: 'iac-fundamentals.md', title: 'Infrastructure as Code : les fondamentaux', cat: 'Cloud, AWS, Azure & IaC', level: 3, min: 50, skills: ['cloud', 'archi'], practiceRefs: [{ kind: 'exercise', id: 'k8s-config-drift' }, { kind: 'exercise', id: 'iac-plan-destructive' }, { kind: 'exercise', id: 'iac-idempotent-changes' }] },
