...
const TESTS = [{"id":"t1","kind":"call-equals","export":"selectTool","args":[{"need":"read-file"},[{"id":"web","capability":"search-web"},{"id":"fs","capability":"read-file"}]]},{"id":"t2","kind":"call-equals","export":"selectTool","args":[{"need":"send-email"},[{"id":"web","capability":"search-web"},{"id":"fs","capability":"read-file"}]]},{"id":"t3","kind":"call-equals","export":"selectTool","args":[{"need":"search-web"},[{"id":"web","capability":"search-web"}]]}];
(async () => {
