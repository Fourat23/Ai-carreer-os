...
const TESTS = [{"id":"t1","kind":"call-equals","export":"isHardened","args":[{"runAsNonRoot":true,"readOnlyRootFilesystem":true,"dropsAll":true}]},{"id":"t2","kind":"call-equals","export":"isHardened","args":[{"runAsNonRoot":false,"readOnlyRootFilesystem":true,"dropsAll":true}]},{"id":"t3","kind":"call-equals","export":"isHardened","args":[{"runAsNonRoot":true,"readOnlyRootFilesystem":false,"dropsAll":true}]},{"id":"t4","kind":"call-equals","export":"isHardened","args":[{"runAsNonRoot":true,"readOnlyRootFilesystem":true,"dropsAll":false}]}];
(async () => {
