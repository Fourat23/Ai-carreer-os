...
const TESTS = [{"id":"t1","kind":"call-equals","export":"consume","args":[[{"id":"a","failsBeforeOk":0},{"id":"a","failsBeforeOk":0}],3]},{"id":"t2","kind":"call-equals","export":"consume","args":[[{"id":"b","failsBeforeOk":5}],3]},{"id":"t3","kind":"call-equals","export":"consume","args":[[{"id":"c","failsBeforeOk":3}],3]},{"id":"t4","kind":"call-equals","export":"consume","args":[[{"id":"x","failsBeforeOk":1},{"id":"y","failsBeforeOk":9},{"id":"x","failsBeforeOk":0}],2]}];
(async () => {
