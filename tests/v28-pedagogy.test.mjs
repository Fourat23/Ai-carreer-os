// CP2 (V28) — intégrité du dispositif d'audit pédagogique V28 : plan, ledger,
...
const ledger = JSON.parse(readFileSync(R('docs/architecture/v28-pedagogy-audit.json'), 'utf8'));
...
test('plan V28 : structure et slugs valides', () => {
...
test('ledger V28 : valide contre la rubrique partagée', () => {
