...
const TESTS = [{"id":"t1","kind":"call-equals","export":"escalate","args":[{"irreversible":true,"cost":0,"sensitive":false,"confidence":0.99}]},{"id":"t2","kind":"call-equals","export":"escalate","args":[{"irreversible":false,"cost":5,"sensitive":false,"confidence":0.95}]},{"id":"t3","kind":"call-equals","export":"escalate","args":[{"irreversible":false,"cost":500,"sensitive":false,"confidence":0.95}]},{"id":"t4","kind":"call-equals","export":"escalate","args":[{"irreversible":false,"cost":5,"sensitive":true,"confidence":0.95}]}];
(async () => {
