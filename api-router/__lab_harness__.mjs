...
const TESTS = [{"id":"t1","kind":"call-equals","export":"matchRoute","args":["GET","/users",[["GET","/users","list"],["POST","/users","create"],["GET","/users/:id","show"]]]},{"id":"t2","kind":"call-equals","export":"matchRoute","args":["POST","/users",[["GET","/users","list"],["POST","/users","create"],["GET","/users/:id","show"]]]},{"id":"t3","kind":"call-equals","export":"matchRoute","args":["GET","/users/42",[["GET","/users","list"],["GET","/users/:id","show"]]]},{"id":"t4","kind":"call-equals","export":"matchRoute","args":["DELETE","/users",[["GET","/users","list"]]]},{"id":"t5","kind":"call-equals","export":"matchRoute","args":["GET","/users/42/posts",[["GET","/users/:id","show"]]]}];
(async () => {
