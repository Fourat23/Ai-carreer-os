...
const TESTS = [{"id":"t1","kind":"call-equals","export":"aggregateHealth","args":[[{"name":"a","status":"up"},{"name":"b","status":"up"}]]},{"id":"t2","kind":"call-equals","export":"aggregateHealth","args":[[{"name":"a","status":"up"},{"name":"b","status":"down"}]]},{"id":"t3","kind":"call-equals","export":"aggregateHealth","args":[[{"name":"a","status":"up"},{"name":"b","status":"degraded"}]]},{"id":"t4","kind":"call-equals","export":"aggregateHealth","args":[[{"name":"a","status":"degraded"},{"name":"b","status":"down"}]]},{"id":"t5","kind":"call-equals","export":"aggregateHealth","args":[[{"name":"a","status":"degraded"},{"name":"b","status":"up"},{"name":"c","status":"degraded"}]]},{"id":"t6","kind":"call-equals","export":"aggregateHealth","args":[[]]}];
(async () => {
