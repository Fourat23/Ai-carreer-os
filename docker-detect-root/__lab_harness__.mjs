...
const TESTS = [{"id":"t1","kind":"call-equals","export":"runsAsRoot","args":[["FROM node","CMD node app"]]},{"id":"t2","kind":"call-equals","export":"runsAsRoot","args":[["FROM node","USER node","CMD node app"]]},{"id":"t3","kind":"call-equals","export":"runsAsRoot","args":[["FROM node","USER root"]]},{"id":"t4","kind":"call-equals","export":"runsAsRoot","args":[["USER 1000"]]},{"id":"t5","kind":"call-equals","export":"runsAsRoot","args":[["USER 0:0"]]}];
(async () => {
