...
const JS_PATHS = [];
const TESTS = [{"id":"t1","name":"le bouton existe","kind":"selector-exists","selector":"#cta","attribute":null,"property":null,"expected":null,"action":null},{"id":"t2","name":"couleur verte (inline)","kind":"computed-style-equals","selector":"#cta","attribute":null,"property":"color","expected":"green","action":null}];
