...
const TESTS = [{"id":"t1","kind":"call-equals","export":"validateArgs","args":[{"required":["amount"],"types":{"amount":"number"},"enums":{"currency":["EUR","USD"]}},{"amount":"5"}]},{"id":"t2","kind":"call-equals","export":"validateArgs","args":[{"required":["amount"],"types":{"amount":"number"}},{}]},{"id":"t3","kind":"call-equals","export":"validateArgs","args":[{"required":["amount"],"types":{"amount":"number"},"enums":{"currency":["EUR","USD"]}},{"amount":5,"currency":"BTC"}]},{"id":"t4","kind":"call-equals","export":"validateArgs","args":[{"required":["amount"],"types":{"amount":"number"}},{"amount":5,"foo":1}]},{"id":"t5","kind":"call-equals","export":"validateArgs","args":[{"required":["amount"],"types":{"amount":"number"},"enums":{"currency":["EUR","USD"]}},{"amount":5,"currency":"EUR"}]}];
(async () => {
