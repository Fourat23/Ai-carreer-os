...
export const LESSONS = [
  ...
  { file: 'api-production-contracts.md', title: 'API de production : idempotence, pagination, limites et versions', cat: 'Web & backend', level: 3, min: 50, skills: ['http', 'se'], practiceRefs: [{ kind: 'exercise', id: 'http-method-idempotent' }, { kind: 'exercise', id: 'api-pagination-choice' }, { kind: 'exercise', id: 'auth-status-decision' }, { kind: 'exercise', id: 'api-router' }] },
  ...
  { file: 'css-fundamentals.md', title: 'CSS : cascade, spécificité et box model', cat: 'Frontend : Web Platform', level: 1, min: 45, skills: ['jsts'], practiceRefs: [{ kind: 'exercise', id: 'css-specificity-order' }, { kind: 'exercise', id: 'css-box-size' }, { kind: 'exercise', id: 'web-inline-style' }, { kind: 'exercise', id: 'web-card' }] },
  { file: 'css-flexbox.md', title: 'CSS Flexbox : aligner et répartir sur un axe', cat: 'Frontend : Web Platform', level: 2, min: 45, skills: ['jsts'], practiceRefs: [{ kind: 'exercise', id: 'web-nav' }, { kind: 'exercise', id: 'web-card' }] },
  { file: 'css-grid.md', title: 'CSS Grid : organiser en lignes et colonnes', cat: 'Frontend : Web Platform', level: 2, min: 50, skills: ['jsts', 'archi'], practiceRefs: [{ kind: 'exercise', id: 'frontend-layout-choice' }, { kind: 'exercise', id: 'web-card' }, { kind: 'exercise', id: 'web-nav' }] },
  ...
  { file: 'typescript-frontend.md', title: 'TypeScript côté frontend : props, événements et données d\'API', cat: 'Frontend : Web Platform', level: 2, min: 50, skills: ['jsts'], practiceRefs: [{ kind: 'exercise', id: 'ts-frontend-guard' }, { kind: 'exercise', id: 'ts-union-area' }, { kind: 'exercise', id: 'ts-interface-cart' }, { kind: 'exercise', id: 'react-profile' }] },

  // ── Frontend & React ──
  { file: 'browser-dom-rendering.md', title: 'Le navigateur, le DOM et le rendu', cat: 'Frontend & React', level: 1, min: 45, skills: ['jsts'], practiceRefs: [{ kind: 'exercise', id: 'web-semantic' }, { kind: 'exercise', id: 'web-counter' }, { kind: 'exercise', id: 'dom-event-delegation' }, { kind: 'exercise', id: 'web-debug-selector' }, { kind: 'exercise', id: 'web-inline-style' }] },
  ...
  { file: 'react-hooks-effects.md', title: 'React : effets, données async et hooks', cat: 'Frontend & React', level: 2, min: 50, skills: ['jsts'], practiceRefs: [{ kind: 'exercise', id: 'react-toggle' }, { kind: 'exercise', id: 'react-form-name' }, { kind: 'exercise', id: 'react-search' }, { kind: 'exercise', id: 'react-parent-child' }, { kind: 'playbook', id: 'frontend-infinite-render' }] },
  ...
  { file: 'react-application-states.md', title: 'De composant à application : routing, useReducer et états d\'écran', cat: 'Frontend & React', level: 3, min: 55, skills: ['jsts', 'archi'], practiceRefs: [{ kind: 'exercise', id: 'react-reducer-actions' }, { kind: 'exercise', id: 'react-search' }, { kind: 'exercise', id: 'react-parent-child' }, { kind: 'playbook', id: 'frontend-regression' }] },
  { file: 'react-accessibility.md', title: 'Accessibilité des interfaces web', cat: 'Frontend & React', level: 2, min: 45, skills: ['jsts'], practiceRefs: [{ kind: 'exercise', id: 'a11y-accessible-name' }, { kind: 'exercise', id: 'web-semantic' }, { kind: 'exercise', id: 'web-card' }, { kind: 'exercise', id: 'react-avatar' }, { kind: 'exercise', id: 'react-debug-list' }] },
  { file: 'frontend-testing.md', title: 'Tester une interface : comportement, pas implémentation', cat: 'Frontend & React', level: 3, min: 50, skills: ['jsts', 'se'], practiceRefs: [{ kind: 'exercise', id: 'react-debug-list' }, { kind: 'exercise', id: 'react-search' }, { kind: 'playbook', id: 'frontend-regression' }, { kind: 'playbook', id: 'feature-regression' }] },
  { file: 'frontend-performance.md', title: 'Performance frontend : mesurer avant d\'optimiser', cat: 'Frontend & React', level: 3, min: 50, skills: ['jsts', 'archi'], practiceRefs: [{ kind: 'exercise', id: 'perf-pair-count' }, { kind: 'exercise', id: 'react-search' }] },
  { file: 'nextjs-foundations.md', title: 'Next.js : pourquoi un framework au-dessus de React ?', cat: 'Frontend & React', level: 3, min: 45, skills: ['jsts'], practiceRefs: [] },
  { file: 'nextjs-rendering.md', title: 'Rendu web : CSR, SSR, SSG et streaming', cat: 'Frontend & React', level: 3, min: 50, skills: ['jsts', 'archi'], practiceRefs: [{ kind: 'exercise', id: 'frontend-rendering-choice' }] },
  { file: 'nextjs-server-client-components.md', title: 'Server Components vs Client Components : le modèle mental', cat: 'Frontend & React', level: 3, min: 50, skills: ['jsts', 'archi'], practiceRefs: [] },
  { file: 'nextjs-data-production.md', title: 'Next.js : données, états d\'erreur et mise en production', cat: 'Frontend & React', level: 3, min: 55, skills: ['jsts', 'archi'], practiceRefs: [{ kind: 'exercise', id: 'react-search' }] },
  // ── Data & SQL ──
  ...
  { file: 'async-messaging-queues.md', title: 'Travail asynchrone : files, workers, retry et idempotence', cat: 'Software engineering & architecture', level: 3, min: 55, skills: ['archi', 'se'], practiceRefs: [{ kind: 'exercise', id: 'queue-idempotent-consumer' }, { kind: 'exercise', id: 'dlq-routing' }, { kind: 'exercise', id: 'retry-backoff-delay' }, { kind: 'playbook', id: 'queue-backlog' }, { kind: 'playbook', id: 'retry-storm' }] },
  { file: 'system-design-scaling.md', title: 'System Design : passer d\'une machine à l\'échelle', cat: 'Software engineering & architecture', level: 2, min: 55, skills: ['archi'], practiceRefs: [{ kind: 'exercise', id: 'cloud-scaling-choice' }, { kind: 'exercise', id: 'cloud-replica-count' }, { kind: 'exercise', id: 'capacity-estimate' }, { kind: 'exercise', id: 'cloud-detect-spof' }, { kind: 'exercise', id: 'cloud-stateful-autoscale' }] },
  { file: 'distributed-systems-failures.md', title: 'Systèmes distribués : ce qui casse quand on distribue', cat: 'Software engineering & architecture', level: 3, min: 55, skills: ['archi'], practiceRefs: [{ kind: 'exercise', id: 'replication-lag-reason' }, { kind: 'exercise', id: 'cloud-detect-spof' }, { kind: 'exercise', id: 'cloud-replica-count' }, { kind: 'exercise', id: 'queue-idempotent-consumer' }, { kind: 'playbook', id: 'replication-lag' }] },
