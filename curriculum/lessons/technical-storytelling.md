...
## 🧩 Prérequis
Tu dois avoir **mené un projet technique avec de vraies décisions**, et savoir en tirer des résultats mesurables (avant/après, chiffres). C'est le seul prérequis réel : il ne s'apprend pas dans une leçon, il se constitue en travaillant — et n'importe quel projet du parcours convient, y compris le tien en cours. Une seule habitude **aide** ici, et elle tient en une phrase : **adapter son propos à qui écoute** — dire à un recruteur ce qu'il peut évaluer, à un pair ce qu'il peut discuter. Elle est approfondie dans `/doc/lessons/technical-documentation`, **programmée huit jours plus loin** ; rien ici ne suppose que tu l'as lue. Aucune aisance orale préalable n'est supposée non plus : le récit se prépare et se répète.
