...
const TESTS = [{"id":"t1","kind":"call-equals","export":"leftJoin","args":[[{"id":1,"name":"A"},{"id":2,"name":"B"}],[{"userId":1,"total":10}]]},{"id":"t2","kind":"call-equals","export":"leftJoin","args":[[{"id":1,"name":"A"}],[{"userId":1,"total":5},{"userId":1,"total":7}]]},{"id":"t3","kind":"call-equals","export":"leftJoin","args":[[{"id":1,"name":"A"}],[]]},{"id":"t4","kind":"call-equals","export":"leftJoin","args":[[{"id":1,"name":"A"}],[{"userId":9,"total":99}]]}];
(async () => {
