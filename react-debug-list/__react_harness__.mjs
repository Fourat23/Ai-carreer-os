...
const ENTRY = "./App.js";
const TESTS = [{"id":"t1","name":"contenu correct","kind":"list-content","selector":".row","attribute":null,"role":null,"expected":["a","b"],"props":{"items":["a","b"]}},{"id":"t2","name":"3 lignes (privé)","kind":"element-count","selector":".row","attribute":null,"role":null,"expected":3,"props":{"items":["x","y","z"]}}];
