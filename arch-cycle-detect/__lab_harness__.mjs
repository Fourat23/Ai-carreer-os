...
const TESTS = [{"id":"t1","kind":"call-equals","export":"hasCycle","args":[{"A":["B"],"B":["C"],"C":[]}]},{"id":"t2","kind":"call-equals","export":"hasCycle","args":[{"A":["B"],"B":["A"]}]},{"id":"t3","kind":"call-equals","export":"hasCycle","args":[{"A":["A"]}]}];
(async () => {
