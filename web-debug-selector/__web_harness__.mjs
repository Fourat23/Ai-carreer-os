...
const TESTS = [{"id":"t1","name":"un clic → 1","kind":"event-changes-text","selector":"#count","attribute":null,"property":null,"expected":"1","action":{"type":"click","selector":"#inc"}},{"id":"t2","name":"trois clics → 3 (privé)","kind":"event-changes-text","selector":"#count","attribute":null,"property":null,"expected":"3","action":{"type":"click","selector":"#inc","times":3}}];
