...
const TESTS = [{"id":"t1","kind":"call-equals","export":"guard","args":["delete_db",{"allowed":["read","search"],"needsApproval":[]}]},{"id":"t2","kind":"call-equals","export":"guard","args":["send_email",{"allowed":["read","send_email"],"needsApproval":["send_email"]}]},{"id":"t3","kind":"call-equals","export":"guard","args":["read",{"allowed":["read"],"needsApproval":["send_email"]}]}];
(async () => {
