...
export interface SearchItem {
  id: string;
  type: 'command' | 'page' | 'day' | 'week' | 'month' | 'skill' | 'project' | 'lesson' | 'track' | 'module' | 'technology' | 'exercise' | 'mission';
  title: string;
  subtitle: string;
  href: string;
  keywords: string;
...
export function buildIndex(program: Program, catalogue?: Catalogue | null, exercises?: ExerciseSummary[] | null, missions?: Array<{ id: string; title: string; category?: string; skills?: string[] }> | null): SearchItem[];
