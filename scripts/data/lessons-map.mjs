...
export const LESSONS = [
  ...
  { file: 'react-application-states.md', title: 'De composant à application : routing, useReducer et états d\'écran', cat: 'Frontend & React', level: 3, min: 55, skills: ['jsts', 'archi'], practiceRefs: [{ kind: 'exercise', id: 'react-search' }, { kind: 'exercise', id: 'react-parent-child' }, { kind: 'playbook', id: 'frontend-regression' }] },
