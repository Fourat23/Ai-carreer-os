 ...
 */
export function recordExerciseSuccess(flat, { exerciseId, title, skills = [], dayRefs = [], at = null, conceptIds = [] }) {
  ...
  const ev = makeEvidence({
    ...
    // V75 · CP3 — D4 : les concepts, quand l'appelant les connaît SANS
    // ambiguïté. Liste vide sinon : on n'en invente jamais un pour remplir le
    // champ, et une preuve sans concept reste parfaitement valide.
    conceptIds,
