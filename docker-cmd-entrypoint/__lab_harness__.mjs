...
const TESTS = [{"id":"t1","kind":"call-equals","export":"classifyForm","args":["CMD [\"node\",\"server.js\"]"]},{"id":"t2","kind":"call-equals","export":"classifyForm","args":["CMD node server.js"]},{"id":"t3","kind":"call-equals","export":"classifyForm","args":["ENTRYPOINT [\"/app/run\"]"]},{"id":"t4","kind":"call-equals","export":"classifyForm","args":["RUN npm ci"]},{"id":"t5","kind":"call-equals","export":"classifyForm","args":["CMD [\"node\",]"]}];
(async () => {
