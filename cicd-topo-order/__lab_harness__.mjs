...
const TESTS = [{"id":"t1","kind":"call-equals","export":"topoOrder","args":[[{"id":"build","needs":["lint","test"]},{"id":"lint"},{"id":"test"}]]},{"id":"t2","kind":"call-equals","export":"topoOrder","args":[[{"id":"a"},{"id":"b","needs":["a"]},{"id":"c","needs":["b"]}]]},{"id":"t3","kind":"call-equals","export":"topoOrder","args":[[{"id":"x"},{"id":"y"}]]},{"id":"t4","kind":"call-equals","export":"topoOrder","args":[[{"id":"root"},{"id":"a","needs":["root"]},{"id":"b","needs":["root"]}]]},{"id":"t5","kind":"call-equals","export":"topoOrder","args":[[]]}];
(async () => {
