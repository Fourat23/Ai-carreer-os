...
const TESTS = [{"id":"t1","kind":"call-equals","export":"optimalOrder","args":[[{"kind":"from"},{"kind":"code"},{"kind":"install"},{"kind":"manifest"}]]},{"id":"t2","kind":"call-equals","export":"optimalOrder","args":[[{"kind":"from"},{"kind":"manifest"},{"kind":"install"},{"kind":"cmd"}]]},{"id":"t3","kind":"call-equals","export":"optimalOrder","args":[[{"kind":"code","n":1},{"kind":"code","n":2}]]},{"id":"t4","kind":"call-equals","export":"optimalOrder","args":[[{"kind":"manifest"},{"kind":"system"},{"kind":"from"}]]},{"id":"t5","kind":"call-equals","export":"optimalOrder","args":[[]]}];
(async () => {
