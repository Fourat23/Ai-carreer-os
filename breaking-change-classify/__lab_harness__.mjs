...
const TESTS = [{"id":"t1","kind":"call-equals","export":"classifyApiChange","args":[{"kind":"add-optional-param"}]},{"id":"t2","kind":"call-equals","export":"classifyApiChange","args":[{"kind":"rename-param"}]},{"id":"t3","kind":"call-equals","export":"classifyApiChange","args":[{"kind":"make-param-required"}]}];
(async () => {
