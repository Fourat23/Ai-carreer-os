...
const TESTS = [{"id":"t1","kind":"call-equals","export":"classifyInput","args":[{"source":"user","containsInstruction":true}]},{"id":"t2","kind":"call-equals","export":"classifyInput","args":[{"source":"system","containsInstruction":true}]},{"id":"t3","kind":"call-equals","export":"classifyInput","args":[{"source":"document","containsInstruction":false}]}];
(async () => {
