// CP2 (V29) — intégrité du dispositif d'audit pédagogique V29 : plan, ledger,
...
const plan = JSON.parse(readFileSync(R('docs/architecture/v29-lessons-plan.json'), 'utf8'));
const ledger = JSON.parse(readFileSync(R('docs/architecture/v29-pedagogy-audit.json'), 'utf8'));
...
test('plan V29 : structure et slugs valides', () => {
...
test('ledger V29 : valide contre la rubrique partagée', () => {
