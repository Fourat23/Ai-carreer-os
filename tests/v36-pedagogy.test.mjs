// CP2 (V36) — intégrité du dispositif d'audit pédagogique V36 : plan, ledger,
...
const plan = JSON.parse(readFileSync(R('docs/architecture/v36-lessons-plan.json'), 'utf8'));
const ledger = JSON.parse(readFileSync(R('docs/architecture/v36-pedagogy-audit.json'), 'utf8'));
...
test('plan V35 : structure et slugs valides', () => {
...
test('ledger V35 : valide contre la rubrique partagée', () => {
