...
const TESTS = [{"id":"t1","kind":"call-equals","export":"runStack","args":[["push 1","push 2","pop","push 3"]]},{"id":"t2","kind":"call-equals","export":"runStack","args":[["push 5","push 6","push 7","pop","pop"]]},{"id":"t3","kind":"call-equals","export":"runStack","args":[["pop","push 9"]]}];
(async () => {
