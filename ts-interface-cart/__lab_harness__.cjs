...
const TESTS = [{"id":"t1","kind":"call-equals","export":"totalWithTax","args":[[{"name":"a","price":10,"qty":2}],0.1]},{"id":"t2","kind":"call-equals","export":"totalWithTax","args":[[],0.2]},{"id":"t3","kind":"call-equals","export":"totalWithTax","args":[[{"name":"x","price":5,"qty":3},{"name":"y","price":2,"qty":1}],0]}];
(async () => {
