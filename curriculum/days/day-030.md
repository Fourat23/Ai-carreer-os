...
## 📚 Concepts
- Le hachage : l'intuition
- Map vs objet (clés de tout type, size, itération)
- Set : appartenance O(1), unicité
- Le refactor O(n²) → O(n)
- Compter, dédoublonner, croiser : les 3 gestes en O(n)
- Quand l'objet suffit encore
