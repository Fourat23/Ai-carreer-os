#!/usr/bin/env node
// Gate V34 — lance : npm run v34:check
//
// Valide STRUCTURELLEMENT les leçons du périmètre V34 (cf.
// docs/architecture/v34-lessons-plan.json) : leçons de la chaîne RAG / IA appliquée durcies
...
// rapport CP11 (docs/PEDAGOGICAL-AUDIT-V34.md).
//
...
const planPath = R('docs/architecture/v34-lessons-plan.json');
if (!existsSync(planPath)) {
  console.log('── Gate V34 (Data foundations + parcours Data/ML)');
  console.log('⚠️  plan v34-lessons-plan.json absent : rien à valider (attendu avant CP2).');
  console.log('\n✅ V34 valide (aucun périmètre déclaré).');
  process.exit(0);
}
...
console.log('\n✅ V34 valide : périmètre conforme (on-ramp, prérequis, vocabulaire, liens, pratique, graphe acyclique, réel/simulé).');
