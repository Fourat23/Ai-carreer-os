...
const TESTS = [{"id":"t1","kind":"call-equals","export":"classifyUpdate","args":[{"kind":"read-then-write"}]},{"id":"t2","kind":"call-equals","export":"classifyUpdate","args":[{"kind":"atomic-increment"}]},{"id":"t3","kind":"call-equals","export":"classifyUpdate","args":[{"kind":"locked-read"}]}];
(async () => {
