...
const TESTS = [{"id":"t1","kind":"call-equals","export":"globalStatus","args":[[{"status":"success"},{"status":"success"}]]},{"id":"t2","kind":"call-equals","export":"globalStatus","args":[[{"status":"success"},{"status":"failed"}]]},{"id":"t3","kind":"call-equals","export":"globalStatus","args":[[{"status":"failed","allowFailure":true},{"status":"success"}]]},{"id":"t4","kind":"call-equals","export":"globalStatus","args":[[{"status":"success"},{"status":"blocked"}]]},{"id":"t5","kind":"call-equals","export":"globalStatus","args":[[{"status":"cancelled"}]]}];
(async () => {
