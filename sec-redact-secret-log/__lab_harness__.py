...
TESTS = json.loads("[{\"id\":\"t1\",\"kind\":\"call-equals\",\"export\":\"redact\",\"args\":[\"user=ada token=abc123 ok\"]},{\"id\":\"t2\",\"kind\":\"call-equals\",\"export\":\"redact\",\"args\":[\"token=zzz\"]},{\"id\":\"t3\",\"kind\":\"call-equals\",\"export\":\"redact\",\"args\":[\"user=bob level=info\"]}]")
ENTRY = "solution.py"
