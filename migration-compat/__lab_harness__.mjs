...
const TESTS = [{"id":"t1","kind":"call-equals","export":"classifyMigration","args":[{"kind":"add-nullable-column"}]},{"id":"t2","kind":"call-equals","export":"classifyMigration","args":[{"kind":"drop-column"}]},{"id":"t3","kind":"call-equals","export":"classifyMigration","args":[{"kind":"add-not-null-without-default"}]}];
(async () => {
