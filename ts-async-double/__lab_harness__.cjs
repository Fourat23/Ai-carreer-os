...
const TESTS = [{"id":"t1","kind":"call-equals","export":"doubleLater","args":[21]},{"id":"t2","kind":"call-equals","export":"doubleLater","args":[0]},{"id":"t3","kind":"call-equals","export":"doubleLater","args":[-5]}];
(async () => {
