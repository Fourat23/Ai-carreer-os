...
const TESTS = [{"id":"t1","kind":"call-equals","export":"apply","args":["add",2,3]},{"id":"t2","kind":"call-equals","export":"apply","args":["mul",4,5]},{"id":"t3","kind":"call-equals","export":"apply","args":["max",7,2]}];
(async () => {
