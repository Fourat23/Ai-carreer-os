...
const TESTS = [{"id":"t1","kind":"call-equals","export":"spofs","args":[[{"kind":"db","critical":true,"count":1,"redundant":false},{"kind":"api","critical":true,"count":2,"redundant":false}]]},{"id":"t2","kind":"call-equals","export":"spofs","args":[[{"kind":"lb","critical":true,"count":1,"redundant":true}]]},{"id":"t3","kind":"call-equals","export":"spofs","args":[[{"kind":"cache","critical":false,"count":1,"redundant":false}]]}];
(async () => {
